...
Make sure you have an up-to-date installation of PyTorch (1.6), Python (3.8) and torchvision (0.7). If you want to use GPUs, then a CUDA installation (10.1) is also required.
