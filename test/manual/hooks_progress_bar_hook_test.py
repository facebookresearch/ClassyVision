...
class TestProgressBarHook(HookTestBase):
    ...
    @mock.patch("classy_vision.hooks.progress_bar_hook.is_leader")
    def test_progress_bar(
        self, mock_is_leader: mock.MagicMock, mock_progressbar_pkg: mock.MagicMock
    ) -> None:
        """
        ...
        # check that a progress bar is not created if is_leader() returns False
        ...
        try:
            ...
            self.fail("Received Exception when is_leader() is False: {}".format(e))
