...
def recursive_copy_to_gpu(value, non_blocking: Dict = True):
    """
...
def get_checkpoint_dict(task, input_args: Optional[Dict], deep_copy: bool = False):
...
def flatten_dict(value_dict, prefix="", sep="_") -> Dict:
    """
...
def get_model_dummy_input(
    model, input_shape, input_key, batchsize: int = 1, non_blocking: bool = False
):
